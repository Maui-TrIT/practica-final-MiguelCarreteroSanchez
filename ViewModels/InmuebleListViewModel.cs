...
public partial class InmuebleListViewModel:ViewModelGlobal , IQueryAttributable
{
    ...
    public InmuebleListViewModel(INavigationService navegacionService, InmuebleService inmuebleService)
    {
    ...
    public async Task LoadDataAsync(int categoryId)
    {
        ...
        {
            IsBusy = true;
            var listInmuebles = await _inmuebleService.GetInmuebleByCategory(categoryId);
